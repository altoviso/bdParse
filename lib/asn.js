...
var
  ...
  factories= {
    ...
    makeLabel: function(
      ...
      return new asn(arguments.callee.nodeType, sumLocations(labelToken, statement), [labelToken, statement]);
    },
    ...
    makeFunctionDef: function(
     ...
     return new asn(arguments.callee.nodeType, sumLocations(functionToken, rightBrace || body), [nameToken, parameterList, body], comment);
    },
